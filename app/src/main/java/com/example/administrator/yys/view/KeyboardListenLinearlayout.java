...
public class KeyboardListenLinearlayout extends LinearLayout {
    ...
    public KeyboardListenLinearlayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public KeyboardListenLinearlayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
