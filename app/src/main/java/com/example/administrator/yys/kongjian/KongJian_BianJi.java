...
public class KongJian_BianJi extends Activity implements View.OnClickListener{
    LinearLayout fanhui;
    TextView jilu;
    EditText edit;
    LinearLayout chatu;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kongjian_gushi_bianji);
        AppManager.getAppManager().addActivity(this);
        fanhui = (LinearLayout) findViewById(R.id.kongjian_gushi_bianji_fanhui);
        jilu = (TextView) findViewById(R.id.kongjian_gushi_bianji_jilu);
        edit = (EditText) findViewById(R.id.kj_bianji_edit);
        chatu = (LinearLayout) findViewById(R.id.kj_bianji_chatu);
        userinfo = getSharedPreferences("user",MODE_PRIVATE);
        progress = findViewById(R.id.bianji_progress);
        wenzhanginfo = getSharedPreferences("wenzhang",MODE_PRIVATE);

        Intent intent = getIntent();
        callbackintent = intent.getParcelableExtra("callbackintent");
        default_id = intent.getStringExtra("default_id");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1 && data!=null) {
            ...
            if (bitmap != null) {
                ...
                Toast.makeText(KongJian_BianJi.this, "获取图片失败",Toast.LENGTH_SHORT).show();
            }
        }
       /* if (requestCode == 2) {
            originalUri =data.getData();
    ...
    private void insertIntoEditText(SpannableString ss) {
        ...
        edit.append("\n");
        Log.w("图片插入message:","插入了一次"+edit.getText());
        edit.setSelection(edit.getSelectionStart());//置Edittext中光标在最后面显示
    }
        ...
        public void handleMessage(Message msg) {
            ...
            if(msg.what==1 && msg.obj!=null){
                ...
                try {
                    ...
                    if (code.equals("1")){
                        KongJian_BianJi.this.setResult(5,callbackintent);
                        finish();
                    }
                    Toast.makeText(KongJian_BianJi.this,obj.getString("message"),Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.kongjian_gushi_bianji_fanhui:
                InputMethodManager imm = (InputMethodManager) getSystemService(INPUT_METHOD_SERVICE);
                imm.hideSoftInputFromWindow(getCurrentFocus().getWindowToken(), 0);
                finish();
                break;
            case R.id.kongjian_gushi_bianji_jilu:

                if (edit.getText().toString().length()<120){
                    Toast.makeText(KongJian_BianJi.this,"故事字数不能少于120个字",Toast.LENGTH_SHORT).show();
                }else {
                    Log.w("sizeinfo",totalsize+" "+usedsize+"  "+useingsize);
