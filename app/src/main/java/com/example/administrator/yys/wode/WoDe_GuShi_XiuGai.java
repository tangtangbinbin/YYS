...
public class WoDe_GuShi_XiuGai extends Activity implements View.OnClickListener{
    TextView jilu;
    EditText edit;
    LinearLayout chatu;
    String content = "";
        ...
        switch (view.getId()){
            case R.id.kongjian_gushi_info_geren_jilu:
                if (edit.getText().toString().length()<=120){
                    Toast.makeText(WoDe_GuShi_XiuGai.this,"内容不能小于120字",Toast.LENGTH_SHORT).show();
                }
                else{
                    tijiao();
                }
